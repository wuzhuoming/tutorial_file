...
class TranslationMultiSimpleEpochTask(LegacyFairseqTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        args.label_smoothing = params['label_smooth']
        args.lr = [params['lr']]
        args.lr_scheduler = params['lr_scheduler']
        args.warmup_updates = params['warmup_update']
    ...
    def valid_step(self, sample, model, criterion):
        ...
        if self.cur_epoch >= self.max_epoch:
            report_dict = {'runtime':self.spent_time,'default':loss}   
