...
@register_task('translation_multi_simple_epoch_nni')
class TranslationMultiSimpleEpochNNITask(LegacyFairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        ...
        for _, lang_dict in dicts.items():
            if dict0 is None:
                ...
                "TranslationMultiSimpleEpochNNITask only supports one shared dictionary across all languages"
